...
export default function CheckoutPage() {
  ...
  const placeOrder = async () => {
    await clear();
    setMessage("🎉 Your order has been placed successfully!, you'll receive an email when your order is processed");
  ...
  // ⭐ IMPORTANT FIX:
  // If an order was placed, SHOW THE MESSAGE even if cart is empty
  if (message) {
    return (
  ...
  // Normal empty cart page only if NO message exists
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-8 bg-green-50 rounded-3xl shadow-xl">
        ...
        {!discountPercent && (
          <div className="text-right">
            <Link href="/discount" className="text-blue-600 underline hover:text-blue-800 font-medium">
